...
import com.samoyer.backend.model.dto.userinterfaceinfo.UserInterfaceInfoAddRequest;
import com.samoyer.backend.model.dto.userinterfaceinfo.UserInterfaceInfoQueryRequest;
import com.samoyer.backend.model.dto.userinterfaceinfo.UserInterfaceInfoUpdateRequest;
...
public class UserInterfaceInfoController {
    ...
    @GetMapping("/get/{id}")
    @AuthCheck(mustRole = UserConstant.ADMIN_ROLE)
    public BaseResponse<UserInterfaceInfo> getInterfaceInfoById(@PathVariable long id) {
        if (id <= 0) {
            throw new BusinessException(ErrorCode.PARAMS_ERROR);
        }
